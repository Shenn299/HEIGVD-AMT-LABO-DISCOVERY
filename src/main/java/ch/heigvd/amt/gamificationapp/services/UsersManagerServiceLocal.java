...
public interface UsersManagerServiceLocal {
    ...
    /**
     * Create a new {@code String} by decoding the array of bytes of the
     * provided String using the UTF-8
     * {@linkplain java.nio.charset.Charset charset}.
     *
     * @param stringToNormalize the string to normalize.
     * @return the new string normalized.
     */
    public String normalize(String stringToNormalize);

    /**
     * Check if the provided String is not null, is not empty and doesn't
     * contain only space.
     *
